...
export const reviews = [
  {
    review:
      "Uzair did an exceptional job bringing Rockdale Wreaths to life from scratch. His professionalism, attention to detail, and timely delivery exceeded my expectations. I couldn’t have asked for a better developer to work with!",
    name: "Michael Kelley",
    company: "Rockdale Wreaths Inc.",
  },
  {
    review:
      "Uzair played a pivotal role in developing Threat Defence from scratch. His expertise and commitment to quality were evident throughout the project, and the final product exceeded all expectations. Highly recommend his work!",
    name: "Anton Guzhevskiy",
    company: "ThreatDefence.",
  },
  {
    review:
      "Uzair’s work on Deep Lawn was outstanding. From start to finish, he showed exceptional skill and dedication, delivering a top-quality product. It was a pleasure working with him!",
    name: "Joel Northrup",
    company: "Deep Lawn.",
  },
  {
    review:
      "Uzair did an excellent job developing the admin dashboard for Scintillant Ventures. His work was efficient, well-organized, and exactly what we needed to streamline operations. Highly recommend his services!",
    name: "Ron Ejercito",
